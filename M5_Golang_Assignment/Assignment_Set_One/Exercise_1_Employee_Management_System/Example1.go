...
func fillSampleData(employees *[]Employee) {
	*employees = []Employee{
		{ID: 1, Name: "Gaurav Sharma", Age: 25, Department: HR},
		{ID: 2, Name: "Ayush Sharma", Age: 30, Department: IT},
		{ID: 3, Name: "Deepak Sharma", Age: 35, Department: FINANCE},
		{ID: 4, Name: "Ankit Sharma", Age: 35, Department: SALES},
	}
}
